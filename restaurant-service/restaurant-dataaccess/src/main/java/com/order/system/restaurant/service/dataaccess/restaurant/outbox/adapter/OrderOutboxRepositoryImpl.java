package com.order.system.restaurant.service.dataaccess.restaurant.outbox.adapter;

import com.order.system.outbox.OutboxStatus;
import com.order.system.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import com.order.system.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import com.order.system.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import com.order.system.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import com.order.system.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
