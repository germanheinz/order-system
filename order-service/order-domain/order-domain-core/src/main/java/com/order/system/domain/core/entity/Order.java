...
public class Order extends AggregateRoot<OrderId> {
    ...
    public final RestaurantId restaurantId;
    public final StreetAddress deliveryAddress;
    ...
    private void validateItemPrice(OrderItem orderItem) {
        if(!orderItem.isPriceValid()){
            throw new OrderDomainException("Oder Item price: " + orderItem.getPrice().getAmount() + " is not valid for product " + orderItem.getProduct().getId());
        }
